...
export default function Login() {
  ...
  const handleAuthSuccess = (userObj) => {
    ...
    setStatusMsg(`Welcome, ${userObj.name || userObj.email.split("@")[0]}! Launching terminal...`);
    setTimeout(() => {
      navigate("/markets");
    }, 750);
  };
  ...
  const handleSocialSignIn = (provider) => {
    ...
    setTimeout(() => {
      ...
      handleAuthSuccess({
        email: `${provider.toLowerCase()}.user@asteron.io`,
        name: `${provider} User`,
        type: "social",
        provider,
        authTime: Date.now(),
    ...
    <div className="login-page">
      <div className="login-container">
        <div className="login-card">
          {/* Frameless transparent back icon on top-left corner */}
          <Link
            to="/"
          ...
          {/* Frameless Optional Social Sign In: Original Google, Apple, GitHub */}
          ...
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            {/* Submit Action without lighting/glow */}
            <button
              type="submit"
